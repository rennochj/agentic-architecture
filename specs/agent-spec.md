# Agent Spec: Agentic AI Solution Designer
...
The framework is organized into six documents. Load them as reference context before beginning:

| Doc | Document | Layer |
|-----|----------|-------|
| 02 | `docs/framework/use-case-archetypes.md` | Layer 1: WHAT — 13 archetypes, 4 architectural dimensions, composition rules, NIST RMF |
| 03 | `docs/framework/capability-features.md` | Layer 2: WHY — 15 features, Matrix A (Archetypes→Features), Matrix B (Features→Components), Matrix C (quick lookup) |
| 04 | `docs/framework/technical-components.md` | Layer 3: HOW — full component catalog (13 capability components + 11 OE sections) |
| 05 | `docs/framework/component-selection-guide.md` | Evaluation tool — Seven Questions, Component Selection Canvas, anti-patterns |
| 06 | `docs/framework/implementation-tiers.md` | Maturity — T1–T4 tiers, Feature Maturity matrix, NFR checklists, stack patterns |
| 07 | `docs/framework/platform-selection.md` | Layer 4: WHERE — platform comparison, decision trees, TCO |
