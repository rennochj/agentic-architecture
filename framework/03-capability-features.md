...
Two capability components in [04-technical-components.md](04-technical-components.md) are structural prerequisites rather than feature-specific runtime enablers, so they are not columns in Matrix B:
