...
Use **Matrix A** in [03-capability-features.md](capability-features.md) to build this merged profile, then trace through **Matrix B** and the **Features × Tiers** matrix in [06-implementation-tiers.md](implementation-tiers.md) as usual.
...
!!! note "Goal"
    ...
    Automatically research regulatory changes, generate a compliance impact report, and file it into the GRC system.
...
- **What capability features are required?** Use Matrix A in [03-capability-features.md](capability-features.md) (for composites, use the merged feature set).
...
- **[03-capability-features.md](capability-features.md)** — Layer 2: Features required by each archetype
