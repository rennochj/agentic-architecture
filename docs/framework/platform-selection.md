...
1. **Know your archetype, features, and tier** — via [02-use-case-archetypes.md](use-case-archetypes.md), [03-capability-features.md](capability-features.md), and [06-implementation-tiers.md](implementation-tiers.md).
...
- **[02-use-case-archetypes.md](use-case-archetypes.md)** — Layer 1: Archetype definitions
- **[04-technical-components.md](technical-components.md)** — Layer 3: Component catalog
- **[06-implementation-tiers.md](implementation-tiers.md)** — Maturity tiers & stack patterns
